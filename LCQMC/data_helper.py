...
# train_q1, train_q2, train_label = read_data('./data/cut_word/LCQMC_train1.txt')
# test_q1, test_q2, test_label = read_data('./data/cut_word/LCQMC_test1.txt')
# dev_q1, dev_q2, dev_label = read_data('./data/cut_word/LCQMC_dev1.txt')
