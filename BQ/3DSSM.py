...
def siamese_model(params):
    ...
    similarity = MaxPooling3D(pool_size=(params["pool_size1"],1,params["pool_size3"]), strides=[params["pool_stride1"],1,params["pool_stride3"]], padding="valid", data_format="channels_last")(similarity)
...
if __name__ == '__main__':
    ...
    params13 = {"lstm_dim": 300,  
                "conv3d_dim": 16,
                "conv3d_kernel_1": 5, "conv3d_stride_1": 1,
                "conv3d_kernel_3": 4, "conv3d_stride_3": 2,
                "sim_conv3d_dim": 32,
                "sim_conv3d_kernel_1": 3, "sim_conv3d_stride_1": 2,
                "sim_conv3d_kernel_3": 4, "sim_conv3d_stride_3": 2,
                "pool_size1": 4, "pool_stride1": 1,
                "pool_size3": 5, "pool_stride3": 3,
                "dropout": 0.6}
